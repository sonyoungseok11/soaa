...
<?
	$rs = fn_select_fetch_array("distinct(title_nm)","common_selectbox","code='35'")
?>
<section class="contents">
            	<div class="contents_con">
                    ...
                    <div class="contain">
                        <div class="confi_box">
                            <div class="confi_btn"><input type="button" value="추가" id="submit_btn" onclick="addList('35')"></div>
                            <div class="clear"></div>
                            <div class="confi_table">
                                <table>
									...
									<?
										...
										$tot_cnt = fn_select_cnt("*", "common_selectbox", "code='35'");
										
										$result = fn_select("code, en_nm, ko_nm, insert_date, update_date", "common_selectbox", "code='35'");
