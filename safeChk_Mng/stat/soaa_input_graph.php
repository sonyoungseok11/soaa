...
<link rel="stylesheet" type="text/css" href="/css/admin/soaa_input_graph.css">
<?
	if($_GET['gubun']){
		$gubun	=	$_GET['gubun'];
	}else{
...
?>
            ...
            <section class="contents">
				...
				<form name="form" method="post">
                    <div class="top_unit">
                        <div class="inner_jump"><a href="#"><span class="first">HOME</span></a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="#">통계&nbsp;관리</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="#">입금&nbsp;통계&#40;구청별&#41;</a></div>
                        <div class="clear"></div>
                        <p class="contop_title"><img src="/img/set_icon.png" alt="icon">입금&nbsp;통계&#40;구청별&#41;<span class="info_notice"><a href="#"><img src="/img/notice.png" alt="알림"></a></span></p>
                    </div>
                    <div class="line"></div>
                    <div class="contain">
                        <div class="con1">
                            <input type="button" value="년도별" id="submit_btn01" onclick="move_report_cate('soaa_input_graph','month')";>
							<input type="button" value="월별" id="submit_btn02" onclick="move_report_cate('soaa_input_graph','day')";>
                            <input type="button" value="기간별" id="submit_btn03" onclick="move_report_cate('soaa_input_graph','period')";>
                        </div>
                        <div class="con2">
                            <div class="con2_toptip">
								...
								?>
                                <div class="stats">
                                	<p class="stats_txt">총 <span class="c_red"><?=$rs['pc_cnt']?></span>건&nbsp;&#47;&nbsp;
															<span class="c_red"><?=number_format($rs['pc_sum']);?></span>원</p>
									<span class="f_right">
										<input type="button" value="인쇄" id="submit_btn04" onclick="move_print_page('soaa_input_graph');">
										<input type="button" value="엑셀저장" id="submit_btn05" onclick="ExcelDown_2('soaa_input_graph_excel','<?=$excel_where?>');">
									</span>
								</div>
                            </div><!--con2_toptip-->
                            ...
                            <table>
                                ...
                                <tr>
                                    <th rowspan="2">구청</th>
                                    <th colspan="2">입금&nbsp;금액</th>
                                    <th colspan="2">환불&nbsp;금액</th>
                                    <th colspan="2">합계</th>
                                </tr>
                                <tr>
                                    <th>건수</th>
