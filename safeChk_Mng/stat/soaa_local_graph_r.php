...
<link rel="stylesheet" type="text/css" href="/css/admin/soaa_local_graph_r.css">
<?
	if($_GET['gubun']){
		$gubun	=	$_GET['gubun'];
	}else{
...
//	echo "넘겨받은 1_년도값=" . $select_y . "<br>";
//	echo "넘겨받은 1_월값=" . $select_m . "<br>";
//	echo "넘겨받은 1_일값=" . $select_d . "<br>";
//
//	echo "넘겨받은 2_월값=" . $select_mm . "<br>";
//	echo "넘겨받은 2_일값=" . $select_dd . "<br>";
...
?>
            <section class="contents">
            	<div class="contents_con">
                    ...
                    <div class="top_unit">
                        <div class="inner_jump"><a href="#"><span class="first">HOME</span></a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="#">통계&nbsp;관리</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="#">검사&nbsp;접수&nbsp;통계&#40;접수일&#41;</a></div>
                        <div class="clear"></div>
                        <p class="contop_title">
							<img src="/img/set_icon.png" alt="icon">검사&nbsp;접수&nbsp;통계&#40;접수일&#41;
                    ...
                    <div class="contain">
                        <div class="con1">
                            <input type="button" value="년도별" id="submit_btn01" onclick="move_report_cate('soaa_local_graph_r','month')";>
							<input type="button" value="월별" id="submit_btn02"  onclick="move_report_cate('soaa_local_graph_r','day')";>
                            <input type="button" value="기간별" id="submit_btn03" onclick="move_report_cate('soaa_local_graph_r','period')";>
                        </div>
                        <div class="con2">
							...
							?>
                                ...
                                <div class="stats">
									...
									<span class="f_right">
										<input type="button" value="인쇄" id="submit_btn04" onclick="move_print_page('soaa_local_graph_r');">
										<input type="button" value="엑셀저장" id="submit_btn05" onclick="ExcelDown_2('soaa_local_graph_r_excel','<?=$excel_where?>');">
									</span>
								</div>
                            </div><!--con2_toptip-->
