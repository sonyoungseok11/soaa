...
//		echo "select_dd=" . $select_dd . "<br>";		
	...
	switch($gubun){
		...
		case "period":
			$where =	" and date_format(insert_date, '%Y-%m-%d') between ('$select_y" . "-" ."$select_m" . "-" . "$select_d') and ('$select_yy" . "-" ."$select_mm" . "-" . "$select_dd')";	break;
	}
...
<table border="1">
	<tr>
		<th class="title" colspan="15">안전 점검 통계(검사월) [검색기간] : <?=$search_echo?></th>
	</tr>
	<!--
	<tr>
		<th class="search_gigan" colspan="15">[검색기간] <?=$search_echo?></th>
	</tr>
	-->
	<tr>
