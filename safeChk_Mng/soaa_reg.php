...
//	$soaa_reg_check_del = fn_delete("soaa_reg_check", "insert_id is null");
	...
	$rs = fn_select_fetch_array("reg_no", "soaa_reg_check", "reg_no is not null order by reg_no desc limit 0,1");
	$reg_no = $rs["reg_no"];
...
//	$soaa_reg_insert = fn_insert("reg_no", "'$reg_no'", "soaa_reg_check");
	$soaa_reg_check_insert = fn_insert("reg_no", "'$reg_no'", "soaa_reg_check");

	$rs = fn_select_fetch_array("reg_no", "soaa_reg_check", "reg_no='$reg_no'");
?>
<!--
