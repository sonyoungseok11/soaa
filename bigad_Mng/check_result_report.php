...
<?
	if($_POST["st_date"] <> "" || $_POST["ed_date"] <> "" ||$_POST["gu_office"] <> "" ||$_POST["c_corp_nm"] <> "" ||$_POST["c_ceo_nm"] <> "" ||$_POST["reg_no"] <> "" ||
		...
		|| $_POST["select_page_num"] || $_POST['listNum']){
...
//											}
                                    ...
                                    <tr class="listColorChange">
                                        ...
                                        <td class="corp_name"><img src="/img/<?=$rs["outdoor_act_cate"]?>.png" alt="지주"></td>
                            ...
                            <? if($tot_cnt > 0) { ?>
								<div class="arrow_navi">
									<?
										...
										$go_page=1;
									?>
									<a href="javascript:void(0);" onclick="navi_check_result_report('check_result_report','<?=$go_page?>','<?=$select_page_num?>','<?=$st_date?>',
									'<?=$ed_date?>','<?=$gu_office?>','<?=$c_corp_nm?>','<?=$c_ceo_nm?>','<?=$reg_no?>','<?=$outdoor_act_cate?>',
									'<?=$chk_paytype?>','<?=$report_certi?>','<?=$chk_result?>','<?=$i?>');">
									...
									<? }else{ ?>
										<li>
											<a href="javascript:void(0);" onclick="navi_check_result_report('check_result_report','<?=$page_link?>','<?=$select_page_num?>','<?=$st_date?>',
											'<?=$ed_date?>','<?=$gu_office?>','<?=$c_corp_nm?>','<?=$c_ceo_nm?>','<?=$reg_no?>','<?=$outdoor_act_cate?>',
											'<?=$chk_paytype?>','<?=$report_certi?>','<?=$chk_result?>','<?=$i?>');"><?=$page_link?></a>
										</li>
									<? }//end if
									}//end for
									?>
