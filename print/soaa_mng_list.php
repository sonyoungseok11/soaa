...
<?
	...
	<div class="title">안전&nbsp;점검&nbsp;관리대장</div>
...
<?
			...
			//한개의 블럭이 출력될때 5줄의 데이터가 출력된된후 블럭이 마감되어야 함.
			if($cut_no == $select_page_num+1){
				echo "</table>";
			}
		}	//end while
?>
